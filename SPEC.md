...
- **No payment moves through the app in the PoC.** A stake is a ledger entry only; members settle up externally, by whatever means the group already uses. This is a current scope boundary, not a permanent one — see _Payment handling_ in the Roadmap below.
